...
public class RestaurantAPIController {
    ...
    public ResponseEntity<RestaurantDto> find(@PathVariable("id") Long id){
        return ResponseEntity.ok(restaurantRepositorySupport.findOneRestaurantDto(id));
    }
    ...
    public ResponseEntity<List<RestaurantDto>> findAll(){
        return ResponseEntity.ok(restaurantRepositorySupport.findRestaurantDtos());
    }
}
